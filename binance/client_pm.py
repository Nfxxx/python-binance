...
class BaseClient:
    ...
    # For accessing the data returned by PortfolioClient.aggregate_trades().
    AGG_ID = 'a'
    AGG_PRICE = 'p'
    AGG_QUANTITY = 'q'
    ...
    def __init__(
        ...
        """Binance API PortfolioClient constructor
        ...
        self.PORTFOLIO_URL = self.PORTFOLIO_URL.format(tld)
    ...
    def _create_options_api_uri(self, path: str, version=1) -> str:
        url = self.OPTIONS_URL
        options = {1: self.FUTURES_API_VERSION, 2: self.FUTURES_API_VERSION2}
        return url + '/' + self.OPTIONS_API_VERSION + '/' + path

    def _create_portfolio_api_uri(self, path: str, version=1) ->str:
...
class PortfolioClient(BaseClient):
    ...
    def _request_futures_api(self, method, path, signed=False, **kwargs) -> Dict:
        ...
        uri = self._create_portfolio_api_uri(path)
    ...
    def _request_futures_coin_api(self, method, path, signed=False, version=1, **kwargs) -> Dict:
        ...
        uri = self._create_portfolio_api_uri(path, version)
        return self._request(method, uri, signed, True, **kwargs)
    ...
    def ping(self) -> Dict:
        ...
        """
        resp = self._get('ping', version='v1')
        return resp
    ...
    def get_server_time(self) -> Dict:
        ...
        """
        return self._get('time', version=self.PORTFOLIO_API_VERSION)
    ...
    def aggregate_trade_iter(self, symbol: str, start_str=None, last_id=None):
        ...
        each object is identical to PortfolioClient.aggregate_trades().
    ...
    def get_margin_account(self, **params):
        ...
        """
        return self._request_margin_api('get', 'account', True, data=params)
    ...
    def get_margin_asset(self, **params):
        ...
        """
        return self._request_margin_api('get', 'balance', True, data=params)
    ...
    def futures_account(self, **params):
        ...
        """
        return self._request_futures_api('get', 'um/account', True, data=params)
    ...
    def futures_position_information(self, **params):
        ...
        """
        return self._request_futures_api('get', 'um/positionRisk', True, data=params)
    ...
    def futures_account_trades(self, **params):
        ...
        """
        return self._request_futures_api('get', 'um/userTrades', True, data=params)
    ...
    def futures_coin_position_information(self, **params):
        ...
        """
        return self._request_futures_coin_api("get", "cm/positionRisk", True, data=params)
    ...
    def futures_coin_account_trades(self, **params):
        ...
        """
        return self._request_futures_coin_api("get", "cm/userTrades", True, data=params)
...
class AsyncClient(BaseClient):
    ...
    async def get_products(self) -> Dict:
        ...
        return products
    get_products.__doc__ = PortfolioClient.get_products.__doc__

    async def get_exchange_info(self) -> Dict:
        return await self._get('exchangeInfo', version=self.PRIVATE_API_VERSION)
    get_exchange_info.__doc__ = PortfolioClient.get_exchange_info.__doc__
    ...
    async def get_symbol_info(self, symbol) -> Optional[Dict]:
        ...
        return None
    get_symbol_info.__doc__ = PortfolioClient.get_symbol_info.__doc__

    # General Endpoints

    async def ping(self) -> Dict:
        return await self._get('ping', version=self.PRIVATE_API_VERSION)
    ping.__doc__ = PortfolioClient.ping.__doc__

    async def get_server_time(self) -> Dict:
        return await self._get('time', version=self.PRIVATE_API_VERSION)
    get_server_time.__doc__ = PortfolioClient.get_server_time.__doc__
    ...
    get_all_tickers.__doc__ = PortfolioClient.get_all_tickers.__doc__
    ...
    get_orderbook_tickers.__doc__ = PortfolioClient.get_orderbook_tickers.__doc__

    async def get_order_book(self, **params) -> Dict:
        return await self._get('depth', data=params, version=self.PRIVATE_API_VERSION)
    get_order_book.__doc__ = PortfolioClient.get_order_book.__doc__

    async def get_recent_trades(self, **params) -> Dict:
        return await self._get('trades', data=params)
    get_recent_trades.__doc__ = PortfolioClient.get_recent_trades.__doc__
    ...
    get_historical_trades.__doc__ = PortfolioClient.get_historical_trades.__doc__
    ...
    get_aggregate_trades.__doc__ = PortfolioClient.get_aggregate_trades.__doc__
    ...
    async def aggregate_trade_iter(self, symbol, start_str=None, last_id=None):
        ...
        while True:
            ...
            for t in trades:
                yield t
            last_id = trades[-1][self.AGG_ID]
    aggregate_trade_iter.__doc__ = PortfolioClient.aggregate_trade_iter.__doc__

    async def get_klines(self, **params) -> Dict:
        return await self._get('klines', data=params, version=self.PRIVATE_API_VERSION)
    get_klines.__doc__ = PortfolioClient.get_klines.__doc__
    ...
    async def _klines(self, klines_type: HistoricalKlinesType = HistoricalKlinesType.SPOT, **params) -> Dict:
        ...
        if HistoricalKlinesType.SPOT == klines_type:
            ...
            raise NotImplementedException(klines_type)
    _klines.__doc__ = PortfolioClient._klines.__doc__
    ...
    async def _get_earliest_valid_timestamp(self, symbol, interval,
        ...
        return kline[0][0]
    _get_earliest_valid_timestamp.__doc__ = PortfolioClient._get_earliest_valid_timestamp.__doc__
    ...
    get_historical_klines.__doc__ = PortfolioClient.get_historical_klines.__doc__
    ...
    async def _historical_klines(self, symbol, interval, start_str=None, end_str=None, limit=1000,
        ...
        return output_data
    _historical_klines.__doc__ = PortfolioClient._historical_klines.__doc__
    ...
    get_historical_klines_generator.__doc__ = PortfolioClient.get_historical_klines_generator.__doc__
    ...
    get_orderbook_ticker.__doc__ = PortfolioClient.get_orderbook_ticker.__doc__

    # Account Endpoints

    async def create_order(self, **params):
        return await self._post('order', True, data=params)
    create_order.__doc__ = PortfolioClient.create_order.__doc__
    ...
    order_limit.__doc__ = PortfolioClient.order_limit.__doc__
    ...
    order_limit_buy.__doc__ = PortfolioClient.order_limit_buy.__doc__
    ...
    async def order_limit_sell(self, timeInForce=BaseClient.TIME_IN_FORCE_GTC, **params):
        ...
        return await self.order_limit(timeInForce=timeInForce, **params)
    order_limit_sell.__doc__ = PortfolioClient.order_limit_sell.__doc__
    ...
    async def order_market(self, **params):
        ...
        return await self.create_order(**params)
    order_market.__doc__ = PortfolioClient.order_market.__doc__
    ...
    order_market_buy.__doc__ = PortfolioClient.order_market_buy.__doc__
    ...
    async def order_market_sell(self, **params):
        ...
        return await self.order_market(**params)
    order_market_sell.__doc__ = PortfolioClient.order_market_sell.__doc__

    async def create_oco_order(self, **params):
        return await self._post('order/oco', True, data=params)
    create_oco_order.__doc__ = PortfolioClient.create_oco_order.__doc__
    ...
    order_oco_buy.__doc__ = PortfolioClient.order_oco_buy.__doc__
        ...
        if "balances" in res:
            for bal in res['balances']:
                if bal['asset'].lower() == asset.lower():
                    return bal
        return None
    get_asset_balance.__doc__ = PortfolioClient.get_asset_balance.__doc__

    async def get_my_trades(self, **params):
        return await self._get('myTrades', True, data=params)
    get_my_trades.__doc__ = PortfolioClient.get_my_trades.__doc__

    async def get_system_status(self):
        return await self._request_margin_api('get', 'system/status')
    get_system_status.__doc__ = PortfolioClient.get_system_status.__doc__

    async def get_account_status(self, **params):
        return await self._request_margin_api('get', 'account/status', True, data=params)
    get_account_status.__doc__ = PortfolioClient.get_account_status.__doc__
    ...
    get_account_api_trading_status.__doc__ = PortfolioClient.get_account_api_trading_status.__doc__
    ...
    get_asset_dividend_history.__doc__ = PortfolioClient.get_asset_dividend_history.__doc__
    ...
    make_universal_transfer.__doc__ = PortfolioClient.make_universal_transfer.__doc__
    ...
    query_universal_transfer_history.__doc__ = PortfolioClient.query_universal_transfer_history.__doc__

    async def get_trade_fee(self, **params):
        return await self._request_margin_api('get', 'asset/tradeFee', True, data=params)
    get_trade_fee.__doc__ = PortfolioClient.get_trade_fee.__doc__

    async def get_asset_details(self, **params):
        return await self._request_margin_api('get', 'asset/assetDetail', True, data=params)
    get_asset_details.__doc__ = PortfolioClient.get_asset_details.__doc__
    ...
    withdraw.__doc__ = PortfolioClient.withdraw.__doc__
    ...
    get_deposit_history.__doc__ = PortfolioClient.get_deposit_history.__doc__
    ...
    get_withdraw_history.__doc__ = PortfolioClient.get_withdraw_history.__doc__
    ...
    async def get_withdraw_history_id(self, withdraw_id, **params):
        ...
        raise Exception("There is no entry with withdraw id", result)
    get_withdraw_history_id.__doc__ = PortfolioClient.get_withdraw_history_id.__doc__
    ...
    get_deposit_address.__doc__ = PortfolioClient.get_deposit_address.__doc__
    ...
    async def stream_get_listen_key(self):
        ...
        return res['listenKey']
    stream_get_listen_key.__doc__ = PortfolioClient.stream_get_listen_key.__doc__
    ...
    stream_keepalive.__doc__ = PortfolioClient.stream_keepalive.__doc__
    ...
    stream_close.__doc__ = PortfolioClient.stream_close.__doc__

    # Margin Trading Endpoints
    async def get_margin_account(self, **params):
        return await self._request_margin_api('get', 'margin/account', True, data=params)
    get_margin_account.__doc__ = PortfolioClient.get_margin_account.__doc__
    ...
    get_staking_balance_us.__doc__ = PortfolioClient.get_staking_balance_us.__doc__

    async def get_staking_history_us(self, **params):
        assert self.tld == "us", "Endpoint only available on binance.us"
        return await self._request_margin_api("get", "staking/history", True, data=params)
    get_staking_history_us.__doc__ = PortfolioClient.get_staking_history_us.__doc__
    ...
    get_staking_rewards_history_us.__doc__ = PortfolioClient.get_staking_rewards_history_us.__doc__
    ...
    get_pay_trade_history.__doc__ = PortfolioClient.get_pay_trade_history.__doc__
    ...
    get_convert_trade_history.__doc__ = PortfolioClient.get_convert_trade_history.__doc__
    ...
    convert_request_quote.__doc__ = PortfolioClient.convert_request_quote.__doc__
    ...
    convert_accept_quote.__doc__ = PortfolioClient.convert_accept_quote.__doc__
